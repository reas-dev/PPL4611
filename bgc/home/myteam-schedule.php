            ...
            <div class="container-fluid">
              ...
              <!-- <div class="container col-lg-12 col-xs-12 container-buttons">
                ...
                <div class="row" style="margin-top: 20px;">
                  <div class="col-6 col-lg-2 col-xs-3 col-buttons">
                    <button class="btn btn-secondary buttons-4">Team List</button>
                  </div>
                  <div class="col-6 col-lg-2 col-xs-3 col-buttons">
                    <button class="btn btn-secondary buttons-4 active">Schedule</button>
                  </div>
                </div>
              </div> -->
              ...
              <div class="container col-lg-12 col-xs-12 container-buttons" id="coloring1">
                ...
                <div class="row" style="margin-top: 20px;">
                  <div class="col-12 col-lg-3 col-xs-3 col-buttons text-center">
                    ...
                    <a class="font-weight-bold btn-light disabled" id="menu" type="button">Team List</a>
                  </div>
                  <div class="col-12 col-lg-3 col-xs-3 col-buttons text-center">
                    <!-- <button class="btn btn-secondary buttons-41 active">Most - Liked</button> -->
                    <a class="font-weight-bold btn-light active" id="menu" type="button">Schedule</a>
                  </div>
                </div>
              </div>
                    ...
                    <div class="card-header py-3" id="card-header">
                      <div class="row">
                        ...
                        <div class="col-7 col-lg-8 col-xs-8 mb-2">
                          <div class="row">
                            <div class="col-12 col-lg-12 col-xs-12">
                              <h6 class="m-0 font-weight-bold" id="coloring">Me VS ??</h6>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-12 col-lg-12 col-xs-12">
                        ...
                        <div class="col-12 col-lg-3 col-xs-3 text-right">
                          ...
                          <div class="row">
                            <div class="col-12 col-lg-12 col-xs-12">
                              <h6 class="m-0 font-weight-bold" id="coloring2">Time</h6>
                            </div>
                          </div>
                        </div>
                      </div>
